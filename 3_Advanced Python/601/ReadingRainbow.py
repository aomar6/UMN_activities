...
color = input("What color would you like to look up? ") + ".txt"

# Check that the color entered is one of the colors with an associated file
if (color == "red.txt" or color == "orange" or color == "yellow" or color == "green" or color == "blue" or color == "violet"):
